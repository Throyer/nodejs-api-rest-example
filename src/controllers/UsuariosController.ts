import { Get, JsonController, Param, Post, Body, Put, NotFoundError, OnUndefined, Delete, QueryParams } from "routing-controllers";
...
export class UsuariosController {
	...
	@Get()
	async index(@QueryParams() params: UsuarioQueryParams): Promise<Page<Usuario>> {
